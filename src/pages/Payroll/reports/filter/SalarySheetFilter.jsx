...
const SalarySheetFilter = () => {
    ...
    const handleViewer = () => {
        ...
        const url = `/salarysheetreport?data=${compressQuery(query)}`;
                ...
                <CommonDropDown flexDirection='column' breakpoints={{ size: { sm: 10, md: 10, lg: 10 } }} showFilters={{
                    ...
                    <Grid item size={{ xs: 10, md: 10 }} pr={1}>
                        <Controls.Checkbox label="Department Wise Group" name="department"
                            ...
                            onChange={e => e.target.value ? setGoupByField(e.target.value) : setGoupByField("")}
                            fullWidth />
                    </Grid>
                    <Grid item size={{ xs: 10, md: 10 }} pr={1}>
...
export default SalarySheetFilter