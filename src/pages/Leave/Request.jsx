...
const columns = [
    ...
    { field: 'fromDate', headerName: 'From', flex: 1, valueGetter: ({ row }) => formateISODateTime(row.fromDate) },
    { field: 'toDate', headerName: 'To', flex: 1, valueGetter: ({ row }) => formateISODateTime(row.toDate) },
